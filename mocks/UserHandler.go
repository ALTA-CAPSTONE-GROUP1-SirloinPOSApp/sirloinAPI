...
// RegisterDevice provides a mock function with given fields:
func (_m *UserHandler) RegisterDevice() echo.HandlerFunc {
	ret := _m.Called()
...
// UnregDevice provides a mock function with given fields:
func (_m *UserHandler) UnregDevice() echo.HandlerFunc {
	ret := _m.Called()
